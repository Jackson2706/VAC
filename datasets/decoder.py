...
def get_start_end_idx(video_size, clip_size, clip_idx, num_clips):
    ...
    # logger.info(f"video_size {video_size} start_idx {start_idx} end_idx {end_idx}")
...
, duration=None, frames_length=None):
    ...
    if duration is None:
        ...
        # logger.info(f"video_start_pts {video_start_pts} video_end_pts {video_end_pts} frames_length {frames_length} duration {duration} start_idx {start_idx} end_idx {end_idx}")
    ...
    return frames, fps, decode_all_video#, int(start_idx/83/0.02)
